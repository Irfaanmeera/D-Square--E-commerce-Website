...
const addCoupon = async (req, res) => {
    try {
      ...
      if (!existingCoupon) {
        ...
        res.render('/admin/couponManagement',{message:'Coupon Already Exists'});
      }
    } catch (error) {
      console.error(error);
    }
...
module.exports= {couponPageLoad,addCoupon,addCouponLoad,editCoupon,editCouponLoad,deleteCoupon}